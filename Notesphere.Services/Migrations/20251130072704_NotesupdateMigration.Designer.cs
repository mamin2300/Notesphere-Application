...
namespace Notesphere.Services.Migrations
{
    ...
    [Migration("20251130072704_NotesupdateMigration")]
    partial class NotesupdateMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Notesphere.Entities.NotesModels.Note", b =>
                {
                    ...
                    b.HasOne("Notesphere.Entities.NotesModels.NoteTemplate", "Template")
                        .WithMany("Notes")
            ...
            modelBuilder.Entity("Notesphere.Entities.NotesModels.NoteTag", b =>
                {
                    ...
                    b.HasOne("Notesphere.Entities.NotesModels.Tag", "Tag")
                        .WithMany("NoteTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
